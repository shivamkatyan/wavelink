...
| 16/24-bit lossless | ✅ | **i16 + i24 proven (hash equality via `CodecAdapter24` FLAC/PCM against the recorded i24 goldens, golden_lossless_vs_fakes, 2026-09-13)** |
