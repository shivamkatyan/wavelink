...
| R16 | RT callback alloc/lock/blocking regression | Audio | B2/B6 | RT_CONTRACT.md allowed-op whitelist; wdr_rt no-alloc/no-lock SPSC; rt-guard abort-on-alloc feature; CI stress+watchdog; native-runner RT evidence gate (WSL2 cannot substitute); hardware-lab worst-case validation | open |
